...
```sh
cd ~/.npm/_npx/1a089ac50f181916/node_modules/modern-web-guidance/skills/modern-web-guidance && ~/.nvm/versions/node/v20.19.5/bin/node modern-web.mjs search "<query>"
```
...
```sh
cd ~/.npm/_npx/1a089ac50f181916/node_modules/modern-web-guidance/skills/modern-web-guidance && ~/.nvm/versions/node/v20.19.5/bin/node modern-web.mjs retrieve "<id>"
```
